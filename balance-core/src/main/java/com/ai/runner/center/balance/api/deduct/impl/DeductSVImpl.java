package com.ai.runner.center.balance.api.deduct.impl;
...
import com.ai.runner.center.balance.api.deduct.interfaces.IDeductSV;
...
public class DeductSVImpl implements IDeductSV {
    ...
    public String deductFund(DeductParam param) throws CallerException {
        ...
        return deductBusiSV.deductFund(param);
    }
