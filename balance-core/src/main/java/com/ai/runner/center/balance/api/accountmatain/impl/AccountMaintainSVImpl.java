package com.ai.runner.center.balance.api.accountmatain.impl;
...
import com.ai.runner.center.balance.api.accountmaintain.interfaces.IAccountMaintainSV;
...
public class AccountMaintainSVImpl implements IAccountMaintainSV {
    ...
    public long createAccount(RegAccReq regAccReq) throws CallerException {
        ...
        try {
            ...
            throw DubboExceptAssembler.assemble(e);
        }
        // 将 新创建的账户 的 账户ID返回
        return newAccountId;
    }
